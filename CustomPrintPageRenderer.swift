...
class CustomPrintPageRenderer: UIPrintPageRenderer {
    ...
    override func drawHeaderForPage(at pageIndex: Int, in headerRect: CGRect) {
       ...
       // let textAttributes = [NSAttributedStringKey.font.rawValue: font!, NSAttributedStringKey.foregroundColor: UIColor(red: 243.0/255, green: 82.0/255.0, blue: 30.0/255.0, alpha: 1.0), NSAttributedStringKey.kern: 7.5] as! [String : Any]
        ...
        let textSize = getTextSize(text: headerText as String, font: nil, textAttributes: nil as [String : AnyObject]!)
        ...
        headerText.draw(at: CGPoint(x: pointX, y: pointY), withAttributes: nil)
    }
    ...
    override func drawFooterForPage(at pageIndex: Int, in footerRect: CGRect) {
        ...
        footerText.draw(at: CGPoint(x: centerX, y: centerY), withAttributes: nil)
